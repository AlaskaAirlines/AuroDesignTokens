  ...
  static cleanData(data, platform) {
    ...
    if(platform === 'app') {
      ...
      const keyMappings = {
        ...
        'analyticstrackingprefix': 'analyticsTrackingPrefix',
        'analyticsbrandvariable': 'analyticsBrandVariable',
        ...
        'bodysm': 'bodySm',
        'bodyxs': 'bodyXs',
        'body2xsemphasized': 'body2xsEmphasized',
        'bodydefaultemphasized': 'bodyDefaultEmphasized',
        'bodylgemphasized': 'bodyLgEmphasized',
        'bodysmemphasized': 'bodySmEmphasized',
        'bodyxsemphasized': 'bodyXsEmphasized',
        'displaylg': 'displayLg',
        'displaymd': 'displayMd',
        'displaysm': 'displaySm',
        'displayxs': 'displayXs',
